...
if has('gui_running') || has('termguicolors') || &t_Co == 88 || &t_Co == 256
  ...
  if &background ==# 'dark'
    let s:dark = 1
    let s:mono_1 = ['#ffffff', '145']
    let s:mono_2 = ['#828997', '102']
    let s:mono_3 = ['#5c6370', '59']
    let s:mono_4 = ['#4b5263', '59']

    let s:hue_1  = ['#e5c372', '73'] " Function params
    let s:hue_2  = ['#c28aff', '75'] " Function names
    let s:hue_3  = ['#70b172', '176'] " keywords
    let s:hue_4  = ['#528bff', '114'] " green

    let s:hue_5   = ['#00ffff', '168'] " red 1
    let s:hue_5_2 = ['#EB3358', '130'] " red 2

    let s:hue_6   = ['#fff719', '173'] " orange 1
    let s:hue_6_2 = ['#ff870b', '180'] " classnames

    let s:syntax_bg     = ['#000a14', '16']
    ...
    let s:hue_3  = ['#ff8bff', '127'] " purple
    let s:hue_4  = ['#059900', '71'] " green

    let s:hue_5   = ['#00ffff', '166'] " red 1
    let s:hue_5_2 = ['#00ffff', '160'] " red 2

    let s:hue_6   = ['#e5c372', '94'] " orange 1
    let s:hue_6_2 = ['#e5c372', '136'] " orange 2
...
" Public API --------------------------------------------------------------{{{
function! altone#highlight(group, fg, bg, attr)
