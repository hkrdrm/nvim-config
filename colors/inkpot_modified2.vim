" Vim color file - inkpot_modified2
" Generated by http://bytefluent.com/vivify 2020-01-27
set background=dark
if version > 580
	hi clear
	if exists("syntax_on")
...
set t_Co=256
let g:colors_name = "inkpot_modified2"
...
hi Normal guifg=#cfbfad guibg=#000c14 guisp=#000c14 gui=NONE ctermfg=187 ctermbg=23 cterm=NONE
...
hi LineNr guifg=#4e5b66 guibg=#272936 guisp=#272936 gui=NONE ctermfg=66 ctermbg=237 cterm=NONE
